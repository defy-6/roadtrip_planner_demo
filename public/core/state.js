...
export function createRuntimePlannerState() {
  return { items: [], dragging: null, schedule: [], locations: [], routes: [], placeCategories: [], versionKey: 'xinjiang-roadtrip', plans: [], preferences: { pace: '适中', vehicle: '自驾', buffer: '30' }, dayFilter: '', selectedIndex: null };
}
