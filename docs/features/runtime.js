...
const mapExportPreview = $('#mapExportPreview');
let pendingMapExportCanvas;
const scheduleExportPreview = $('#scheduleExportPreview');
...
const placeEditor = $('#placeEditor');
const placeDropEditor = $('#placeDropEditor');
const placeCreateDropEditor = $('#placeCreateDropEditor');
